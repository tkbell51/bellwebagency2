<template>
  <main>
    <section class="opportunity-header">
      <div class="container">
        <div
          class="opportunity-header__content w-full flex justify-between gap-16"
        >
          <Logo class="w-24" />
        ...
        <div class="flex flex-col lg:flex-row gap-8">
          ...
          <div class="mx-auto">
            ...
            <a
              ...
              class="btn block"
              target="_blank"
              ><span class="text-5xl">Yes, Let's Talk About this</span
              ><br />Click to Schedule a 15 Minute Call on My Calendar</a
            >
          </div>
        </div>
      </div>
